# Snake con música y efectos de sonido 🎵🐍
...
# ---- MÚSICA ----
def musica_juego():
    pygame.mixer.music.load("mfcc-retro-arcade-game-music-297305.mp3")
    pygame.mixer.music.play(-1)  # -1 = loop infinito

def musica_game_over():
    pygame.mixer.music.stop()
    sonido = pygame.mixer.Sound("delon_boomkin-game-over-retro-arcade-game-422478.mp3")
    sonido.play()
...
def reiniciar():
    global serpiente, direccion, comida, puntos, pausado, musica_activa
    serpiente = [(360, 360), (340, 360), (320, 360)]
    direccion = (20, 0)
    comida = nueva_comida()
    puntos = 0
